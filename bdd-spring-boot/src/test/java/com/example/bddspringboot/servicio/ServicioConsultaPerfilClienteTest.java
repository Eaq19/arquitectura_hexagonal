...
class ServicioConsultaPerfilClienteTest {
	...
	void dadoIdClienteExistenteEntoncesDevuelvePerfilCliente() {
        ...
        Optional<PerfilCliente> perfil = Optional.of(PerfilCliente.builder().id(id).nombre("Edison").fechaNacimiento(LocalDate.of(1995, 2, 28)).email("edison@hotmail.com").telefono("+57 312593534").build());
